...
import { Button, Input, Modal } from "@rechakra/react"
```
...
import { Button } from "@rechakra/react/button"
import { Input } from "@rechakra/react/input"
import { Modal } from "@rechakra/react/modal"
```
...
import { buttonRecipe, inputRecipe } from "@rechakra/react/theme"
...
const Modal = lazy(() =>
  import("@rechakra/react/modal").then((mod) => ({
    default: mod.Modal,
  })),
)
