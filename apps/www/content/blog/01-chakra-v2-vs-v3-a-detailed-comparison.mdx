...
```bash
npm install @rechakra/react @emotion/react @emotion/styled framer-motion
```

**version 3:**

```bash
npm install @rechakra/react @emotion/react
...
```jsx
import { List, ListItem } from "@rechakra/react"
...
```jsx
import { createSystem } from "@rechakra/react"
