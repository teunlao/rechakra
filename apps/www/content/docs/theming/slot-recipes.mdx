...
import { chakra, useSlotRecipe } from "@rechakra/react"
...
```tsx title="checkbox.tsx"
import type { RecipeVariantProps } from "@rechakra/react"
import { checkboxSlotRecipe } from "./checkbox.recipe"
...
import { createSlotRecipeContext } from "@rechakra/react"
import { checkboxSlotRecipe } from "./checkbox.recipe"
...
```ts
import type { RecipeVariantProps, UnstyledProp } from "@rechakra/react"
import { checkboxSlotRecipe } from "./checkbox.recipe"
...
```tsx title="theme.ts"
import { createSystem, defaultConfig, defineConfig } from "@rechakra/react"
import { checkboxSlotRecipe } from "./checkbox.recipe"
...
```bash
npx @rechakra/cli typegen ./theme.ts
```

Then, import the generated types in your component.

```tsx title="checkbox.tsx"
import type { SlotRecipeProps, UnstyledProp } from "@rechakra/react"
