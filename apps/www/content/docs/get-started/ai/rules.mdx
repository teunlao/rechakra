...
- Icons: Use lucide-react or react-icons instead of @rechakra/icons
- Hooks: Use react-use or usehooks-ts instead of @rechakra/hooks
- Next.js: Use asChild prop instead of @rechakra/next-js package
...
1. Import from @rechakra/react: Alert, Avatar, Button, Card, Field, Table, etc.
